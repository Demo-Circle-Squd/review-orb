...
[CircleCI Orb Registry Page](https://circleci.com/developer/orbs/orb/demo-circle-squd/review) - The official registry page of this orb for all versions, executors, commands, and jobs described.
...
```yaml
- orb-tools/publish:
    orb_name: demo-circle-squd/review
